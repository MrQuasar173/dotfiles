...
# I don't use bash, but I need something to fall back on if there's an issue with zsh, and to serve as an integrated terminal in 
# apps that struggle with my ZSH config. This entire bashrc was coppied from Daniruiz, check him out https://github.com/daniruiz
# NOT MY CODE:
